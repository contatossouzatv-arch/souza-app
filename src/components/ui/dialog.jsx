...
const DialogOverlay = React.forwardRef(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-slate-950/55 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 sm:backdrop-blur-[2px]",
      className
    )}
    {...props} />
))
...
const DialogContent = React.forwardRef(({ className, children, hideClose = false, hideOverlay = false, overlayClassName, ...props }, ref) => (
  <DialogPortal>
